        ...
        <div class="container py-5">
            <div class="row justify-content-start">
                <div class="col-lg-8 text-center text-lg-start">
                    <h1 class="font-secondary text-primary mb-4">Masta Vape Store</h1>
                    <h1 class="display-1 text-uppercase text-white mb-4">Vape & Recoil Terbaik</h1>
                    <h1 class="text-uppercase text-white fs-6">
                        Jl. Sekolahan, Kedungwringin, Kec. Patikraja, Kabupaten Banyumas, Jawa Tengah 53171, Banyumas, Jawa Tengah, Indonesia 53171
                    </h1>                    
                </div>
            </div>
        </div>
    ...
    <div class="container-fluid pt-5">
        <div class="container">
            <div class="section-title position-relative text-center mx-auto mb-5 pb-3" style="max-width: 600px;">
                ...
                <h1 class="display-4 text-uppercase">Masta Vape Store</h1>
            </div>
            <div class="row gx-5">
                ...
                <div class="col-lg-6 pb-5">
                    <h4 class="mb-4">Toko vape terpercaya dengan berbagai pilihan device, liquid, dan aksesoris berkualitas.</h4>
                    <p class="mb-5">Masta Vape Store hadir untuk para vapers yang mencari produk berkualitas, harga bersaing, dan pelayanan terbaik. Kami menyediakan berbagai macam vaporizer, liquid premium, coil, kapas, hingga aksesoris terbaru dengan tren terkini.</p>
                    <div class="row g-5">
                        <div class="col-sm-6">
                            <div class="d-flex align-items-center justify-content-center bg-primary border-inner mb-4" style="width: 90px; height: 90px;">
                                <i class="fas fa-smoking fa-2x text-white"></i>
                            </div>
                            <h4 class="text-uppercase">Produk Terlengkap</h4>
                            <p class="mb-0">Tersedia berbagai device dan liquid dari brand ternama dengan pilihan rasa dan varian terupdate.</p>
                        </div>
                        <div class="col-sm-6">
                            <div class="d-flex align-items-center justify-content-center bg-primary border-inner mb-4" style="width: 90px; height: 90px;">
                            ...
                            <p class="mb-0">Tim kami siap membantu dengan ramah, memberikan rekomendasi, dan layanan purna jual yang memuaskan.</p>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="container-fluid about py-5">
        <div class="container">
            <div class="section-title position-relative text-center mx-auto mb-5 pb-3" style="max-width: 600px;">
                ...
                <h1 class="display-4 text-uppercase">Cari Yang Kamu Butuhkan</h1>
            </div>
                            ...
                            <div class="col-lg-6">
                                <div class="d-flex h-100">
                                    <div class="flex-shrink-0">
                                        ...
                                        <h4 class="bg-dark text-primary p-2 m-0">Rp.400.000</h4>
                                    </div>
                            ...
                            <div class="col-lg-6">
                                <div class="d-flex h-100">
                                    <div class="flex-shrink-0">
                                        ...
                                        <h4 class="bg-dark text-primary p-2 m-0">Rp.250.000</h4>
                                    </div>
                                    <div class="d-flex flex-column justify-content-center text-start bg-secondary border-inner px-4">
                                        <h5 class="text-uppercase">Pod Oxva</h5>
                                        <span>Pod Oxva adalah sistem pod vape yang dikenal karena desainnya yang ramping, portabilitas</span>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="d-flex h-100">
                                    <div class="flex-shrink-0">
                                        ...
                                        <h4 class="bg-dark text-primary p-2 m-0">Rp.3.000.000</h4>
                                    </div>
                                    <div class="d-flex flex-column justify-content-center text-start bg-secondary border-inner px-4">
                                        <h5 class="text-uppercase">Mod Hexom V3</h5>
                                        <span>Fitur-fitur yang canggih seperti chip Hex-T30 yang mampu menghasilkan daya maksimum hingga 180W</span>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="d-flex h-100">
                                    <div class="flex-shrink-0">
                                        ...
                                        <h4 class="bg-dark text-primary p-2 m-0">Rp.255.000</h4>
                                    </div>
                                    <div class="d-flex flex-column justify-content-center text-start bg-secondary border-inner px-4">
                                        <h5 class="text-uppercase">Pod Smok</h5>
                                        <span>Mudah digunakan, dan biasanya menggunakan pod khusus berisi e-liquid yang bisa diisi ulang atau diganti</span>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="d-flex h-100">
                                    <div class="flex-shrink-0">
                                        ...
                                        <h4 class="bg-dark text-primary p-2 m-0">Rp.380.000</h4>
                                    </div>
                                    <div class="d-flex flex-column justify-content-center text-start bg-secondary border-inner px-4">
                                        <h5 class="text-uppercase">Dovpo MVV 2 Panda Mod</h5>
                                        <span>Mod ini menggunakan dua baterai 18650, memungkinkan daya hingga 280W, sehingga ideal untuk vaping DTL (Direct-to-Lung) dan menghasilkan uap yang tebal</span>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="d-flex h-100">
                                    <div class="flex-shrink-0">
                                        ...
                                        <h4 class="bg-dark text-primary p-2 m-0">Rp.200.000</h4>
                                    </div>
                                    <div class="d-flex flex-column justify-content-center text-start bg-secondary border-inner px-4">
